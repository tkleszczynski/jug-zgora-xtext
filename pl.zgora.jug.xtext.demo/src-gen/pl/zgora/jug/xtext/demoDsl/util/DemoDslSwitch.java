 ...
 * @generated
 */
public class DemoDslSwitch<T> extends Switch<T>
{
  /**
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        LoggerConfig loggerConfig = (LoggerConfig)theEObject;
        T result = caseLoggerConfig(loggerConfig);
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Logger Config</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Logger Config</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseLoggerConfig(LoggerConfig object)
  {
    return null;
  }
