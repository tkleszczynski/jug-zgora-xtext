/**
 */
package pl.zgora.jug.xtext.demoDsl.util;
...
public class DemoDslAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected DemoDslSwitch<Adapter> modelSwitch =
    ...
    {
      @Override
      public Adapter caseLoggerConfig(LoggerConfig object)
      {
        return createLoggerConfigAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link pl.zgora.jug.xtext.demoDsl.LoggerConfig <em>Logger Config</em>}'.
   * <!-- begin-user-doc -->
   ...
   * @generated
   */
  public Adapter createLoggerConfigAdapter()
  {
    return null;
  }

  /**
   * Creates a new adapter for an object of class '{@link pl.zgora.jug.xtext.demoDsl.Appender <em>Appender</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link pl.zgora.jug.xtext.demoDsl.Logger <em>Logger</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
